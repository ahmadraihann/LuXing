    ...
    <div class="site-section" id="about-section">
        <div class="container">
            ...
            <div class="col-md-5 ml-auto">
                ...
                platform untuk menampung laporan permasalahan di kawasan wisata oleh para masyarakat jogja. 
                Melalui platform ini, Dinas DIY akan terbantu dalam mengawasi serta menangani permasalahan 
                yang terjadi di kawasan wisata serta lebih mudah dalam berkomunikasi dengan pihak pengelola.</p>    
            </div>
            </div>
        </div>
    </div>
