                            ...
                            <div class="widget no-box">
                                <h5 class="widget-title">Pintasan<span></span></h5>
                                    <ul class="thumbnail-widget">
                                        <li>
                                            <div class="thumb-content"><a href="/beranda/index">Beranda</a></div>	
                                        </li>
                                        <li>
                                            <div class="thumb-content"><a href="/wisata/populer">Terpopuler</a></div>	
                                        </li>
                                        <li>
                                            <div class="thumb-content"><a href="/wisata/terbaru">Terbaru</a></div>	
                                        </li>
                                        <li>
                                            <div class="thumb-content"><a href="/user/tentangkami">Tentang Kami</a></div>	
                                        </li>
                                    </ul>
                            </div>
                        </div>
